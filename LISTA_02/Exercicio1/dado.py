...
tx = Texture(textures_files, 'Dado com Textura', 900, 900)
...
def DrawGLScene():
    ...
    x_rotation = x_rotation + 0.05                 # X rotation
    y_rotation = y_rotation + 0.05                 # Y rotation
    z_rotation = z_rotation + 0.05                 # Z rotation
